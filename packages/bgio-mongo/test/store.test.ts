...
describe('MongoStore', () => {
  ...
  test('basic', async () => {
    ...
    const state: State = { matchID, ctx: { o: 1 }, G: { o: 2 } } as any;
  ...
  describe('listGames', () => {
    beforeAll(async () => {
      ...
      const state: State = { ctx: { o: 1 }, G: { o: 2 } } as any;
      const players = { 0: { id: 0 } };
      ...
      await db.createGame('gameID', {
        ...
        metadata: {
          players,
          gameName: 'game1',
          createdAt: new Date(2020, 3).getTime(),
      ...
      await db.createGame('gameID2', {
        ...
        metadata: {
          ...
          gameName: 'game1',
          gameover: 'gameover',
          createdAt: new Date(2020, 5).getTime(),
      ...
      await db.createGame('gameID3', {
        ...
        metadata: {
          players,
          gameName: 'game2',
          createdAt: new Date(2020, 4).getTime(),
